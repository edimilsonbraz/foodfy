...
module.exports = {
    async index(req, res) {
        try {
            ...
            let results = await Recipe.userRecipes(userId ) /* MANUTENCAO AQUI  */
            let recipes = results
            ...
            recipesImage = recipesImage.filter(recipe => recipe.user_id == req.session.userId)

            return res.render("admin/recipes/index", { recipesImage, recipes })
